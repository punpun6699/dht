...
while ($row = mysqli_fetch_assoc($result)):?>
          ...
          <p class="temperatureColor"><span class="reading"><span id="ESP32_01_Temp"></span><?php  echo $row["temperature"]; ?> &deg;C</span></p>
          <h4 class="humidityColor"><i class="fas fa-tint"></i> HUMIDITY</h4>
          <p class="humidityColor"><span class="reading"><span id="ESP32_01_Humd"></span><?php echo $row["humidity"];  ?> &percnt;</span></p>
<?php
endwhile;
?>